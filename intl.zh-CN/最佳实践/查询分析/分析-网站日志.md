...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339032501_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339032502_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132503_zh-CN.png)
...
1.  **表格** 
    ...
    * | SELECT sourceIPs, count(*) as count GROUP BY sourceIPs ORDER BY count DESC
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132504_zh-CN.png)
...
2.  **折线图** 
    ...
    * | select date_format(from_unixtime(__time__ - __time__% 60), '%H:%i:%S') as minutes, approx_distinct(remote_addr) as uv, count(1) as pv, avg(request_time) as avg group by minutes order by minutes asc limit 100000
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132505_zh-CN.png)
...
3.  **柱状图** 
    ...
    * | select http_referer, count(1) as count group by http_referer
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132507_zh-CN.png)
...
4.  **条形图** 
    ...
    * | select  request_uri, count(1) as count group by request_uri order by count desc limit 10    
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132508_zh-CN.png)
...
5.  **饼图** 
    ...
    * | select requestURI as uri , count(1) as c group by uri limit 10
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132509_zh-CN.png)

    环图：

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132510_zh-CN.png)

    南丁格尔玫瑰图：

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132511_zh-CN.png)
...
6.  **单值图** 
    ...
    * | select count(1) as PV
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132512_zh-CN.png)
...
7.  **面积图** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132513_zh-CN.png)
...
8.  **地图** 
    ...
    -   中国地图
        ...
        * | select ip_to_province(remote_addr) as address, count(1) as count group by address order by count desc limit 10
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132514_zh-CN.png)
    ...
    -   世界地图
        ...
        * | select ip_to_country(remote_addr) as address, count(1) as count group by address order by count desc limit 10
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132515_zh-CN.png)
    ...
    -   高德地图
        ...
        * | select ip_to_geo(remote_addr) as address, count(1) as count group by address order by count desc limit 10
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339132516_zh-CN.png)

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339232517_zh-CN.png)
...
9.  **流图** 
    ...
    * | select date_format(from_unixtime(__time__ - __time__% 60), '%H:%i:%S') as minute, count(1) as c, request_method group by minute, request_method order by minute asc limit 100000
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339232518_zh-CN.png)
...
10. **桑基图** 
    ...
    * | select sourceValue, targetValue, streamValue group by sourceValue, targetValue, streamValue order by streamValue
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339232519_zh-CN.png)
...
11. **词云** 
    ...
    * | select requestURI as uri , count(1) as c group by uri limit 100
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13211/155719339232520_zh-CN.png)
