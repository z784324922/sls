...
-   示例1：Beats采集数据到日志服务
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/150479/155418802441999_zh-CN.png)
...
-   示例2：Collectd采集数据到日志服务
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/150479/155418802442000_zh-CN.png)
...
-   示例3：使用Telegraf采集数据到日志服务
    ...
    **说明：** Telegraf必须配置一个合法的`tls_ca`路径，您只需使用机器自带的根证书即可。通常Linux环境下根证书CA路径为`/etc/ssl/certs/ca-bundle.crt`。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/150479/155418802442180_zh-CN.png)
...
-   示例4：使用Fluentd采集数据到日志服务
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/150479/155418802442204_zh-CN.png)
...
-   示例5：使用Logstash采集数据到日志服务
    ...
    3.  配置Logstash，示例如下：
        ...
        **说明：** 上述示例为连通性测试的配置，您的生产环境中建议删除stdout的输出配置。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/150479/155418802442205_zh-CN.png)
