...
4.  创建Logtail采集配置，并应用到机器组。您可以通过**数据接入向导**创建Logtail配置以 [文本日志](intl.zh-CN/用户指南/Logtail采集/数据源/文本日志.md)、[Syslog](intl.zh-CN/用户指南/隐藏文件夹/Syslog.md)等，并将该Logtail配置应用到机器组。
