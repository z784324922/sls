...
1.  [Configure a saved search ](#section_byf_w3k_5cb)
2.  [Create an alarm rule](#section_o15_rlk_5cb)
3.  [Configure the alarm action](#section_d35_1mk_5cb)
4.  [View alarm records](#section_kdv_jmk_5cb)

## 1 Configure a saved search {#section_byf_w3k_5cb .section}
...
-   Result statistics \(histogram query\)
    ...
    For example, query the ratio of logs with the status code 200 to all the logs. The query statement is as follows \(detailed query syntax[Query syntax](reseller.en-US/User Guide/Index and query/Query syntax.md)\):

    ![](images/5773_en-US.png "Query Result Statistics ")
...
6.  Configure the saved search, and click **Confirm**.
    ...
    ![](images/5775_en-US.png "Saved search details")


## 2 Create an alarm rule {#section_o15_rlk_5cb .section}
...
2.  Configure the alarm rule and then click **OK**. 
    ...
    ![](images/5776_en-US.png "Rule description")
...
## 3 Configure the alarm action {#section_d35_1mk_5cb .section}
...
1.  In the **Action section ** \> **of the Alarm Rule page, **select **Notifications** from the **Action Type** drop-down list and  then configure the **notification content**.
    ...
    ![](images/5777_en-US.png "Action")

2.  On [Message Center](https://notifications.console.aliyun.com/?spm=5176.202052012811.aliyun_topbar.162.zRRPhO#/subscribeMsg), Click **Message Settings** \> **Common Settings** to enter the Common Settings page.

    ![](images/7260_en-US.png "Common Settings")

     ![](images/7269_en-US.png "Common Settings") 
...
3.  Click **Modify** at the corresponding column **Contact** of **Notification Type** \> **Log Service Alarm Notification**. Open the **Modify Contact** page.
    ...
    ![](images/5778_en-US.png "Modify the Modify Contact and select the receiver ")
...
3.  In the Action section of the Alarm Rule page, select **WebHook-DingTalk Bot** from the Action Type drop-down list and then enter the WebHook link in the WebHook URL field. Enter the notification content in the Content field .
    ...
    ![](images/5783_en-US.png "Notification content ")
...
1.  In the Action section of the Alarm Rule page, select **WebHook-Custom** from the Action Type drop-down list and then enter the WebHook link in the WebHook URL field. Enter the notification content in the Content field \(up to 50 characters, only English letters are supported\).
    ...
    ![](images/5785_en-US.png "Notification Type ")
...
## 4 View alarm records {#section_kdv_jmk_5cb .section}
