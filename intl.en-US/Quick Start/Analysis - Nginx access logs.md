...
2.  Apply to the machine groups.
    ...
    If you have not created a machine group, you must create one first. For how to create a machine group, see [Create a machine group](../../../../reseller.en-US/User Guide/Logtail collection/Machine Group/Create a machine group.md).
...
After the index feature is enabled, you can view the analysis of each indicator on the page where dashboards are generated by default. For how to use dashboards, see [Dashboard](../../../../reseller.en-US/User Guide/Query and visualization/Analysis graph/Dashboard.md).
