...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432403_zh-CN.png)

## 数据投递场景 {#section_6iu_1lp_fra .section}

为数据的目的端落地提供支撑，构建云上大数据产品间的数据管道。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432404_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432405_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432406_zh-CN.png)
...
1.  登录函数计算控制台创建Service。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432407_zh-CN.png)

2.  通过内置模板创建函数。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432408_zh-CN.png)

    默认的函数配置如下：

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106432409_zh-CN.png)

3.  在函数上新建日志服务触发器。

    日志服务触发器配置如下。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106532410_zh-CN.png)
    ...
    不同函数的实现和功能不同，函数的配置也不相同，ip-lookup的详细配置项说明请参考README。
...
4.  保存配置，等待1分钟后ETL任务开始执行。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106532411_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106532412_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13202/156137106532413_zh-CN.png)
