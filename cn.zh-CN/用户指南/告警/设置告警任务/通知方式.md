...
4.  填写**通知内容**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21677/156023384833232_zh-CN.png)
...
2.  在[阿里云消息中心](https://notifications.console.aliyun.com/?spm=5176.202052012811.aliyun_topbar.162.zRRPhO#/subscribeMsg)，单击**消息接收管理** \> **基本接收管理**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13160/15602338487269_zh-CN.png)
...
|Results|查询参数和结果，数组类型。内部字段解释请参考[告警日志字段](intl.zh-CN/用户指南/告警/参考信息/告警日志字段.md)。| ``` {#codeblock_0md_nz4_rp7}
[
  {
    "EndTime": 1542507580,
    "FireResult": {
