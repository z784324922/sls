...
4.  填写**通知内容**。
    ...
    ![自定义](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21677/156439143633232_zh-CN.png)
...
1.  [设置告警](cn.zh-CN/用户指南/告警/设置告警任务/设置告警.md)，其中，通知方式设置为**通知中心**。
2.  在[阿里云消息中心](https://notifications.console.aliyun.com/?spm=5176.202052012811.aliyun_topbar.162.zRRPhO#/subscribeMsg)，单击**消息接收管理** \> **基本接收管理**。
    ...
    ![接收管理](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13160/15643914367260_zh-CN.png)

3.  在**消息类型** \> **日志服务（LOG）告警**对应的**消息接收人**一列单击**修改**。

    ![修改消息接收人](images/5778_zh-CN.png "修改消息接收人")
...
|Results|查询参数和结果，数组类型。内部字段解释请参考[告警日志字段](cn.zh-CN/用户指南/告警/参考信息/告警日志字段.md)。| ``` {#codeblock_0md_nz4_rp7}
[
  {
    "EndTime": 1542507580,
    "FireResult": {
