...
申请通过后，您可以根据需求选择加速区域。|
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16815/15532330928063_zh-CN.png)

4.  根据页面提示，跳转到域名管理页面。

    您可以在域名管理页面中查看对应域名的**CNAME**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16815/15532330928064_zh-CN.png)

5.  登录日志服务控制台，在Project列表中单击指定Project右侧对应的**全球加速**。
6.  在弹出对话框中填入加速域名对应的**CNAME**。并单击**开启加速**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16815/15532330928065_zh-CN.png)
...
4.  配置HTTPS安全加速和证书类型。
    ...
    -   开启HTTPS安全加速功能开关。
    -   证书类型请选择免费证书。
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16815/15532330928066_zh-CN.png)
