...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13028/15415572272604_zh-CN.png)

如上图所示，使用Web Tracking功能可以采集各种浏览器以及iOS、Android APP的用户信息（除[iOS/Android SDK](../../../../cn.zh-CN/SDK 参考/基本介绍/概述.md)外\)，例如：
...
-   **通过控制台开通Web Tracking**
    ...
    2.  打开 Web Tracking 开关。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/13028/15415572272605_zh-CN.png)

-   **通过 Java SDK 开通Web Tracking**

    使用 [JAVA SDK](../../../../cn.zh-CN/SDK 参考/基本介绍/概述.md)：
...
数据上传到日志服务之后，可以使用日志服务[查询分析功能](cn.zh-CN/用户指南/索引与查询/简介.md)实时检索、分析日志数据，并通过多样的可视化方案展示实时分析结果。也可以使用日志服务提供的 [Consumer Library](cn.zh-CN/用户指南/实时订阅与消费/消费组消费.md) 消费数据。
