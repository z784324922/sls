...
-   **隐藏上边栏和侧边栏**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910137608_zh-CN.png)
...
-   **隐藏导航栏返回按钮**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910137609_zh-CN.png)
...
-   **过滤导航栏资源列表**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910137610_zh-CN.png)
...
-   **时间选择器**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910137611_zh-CN.png)
...
-   **设置queryString**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910137618_zh-CN.png)
...
-   **设置readOnly**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910237613_zh-CN.png)
...
-   示例效果
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910237612_zh-CN.png)
...
-   在url中设置参数readOnly，使仪表盘页面为只读模式，即不可编辑。
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910237614_zh-CN.png)
...
-   为仪表盘增加两个过滤条件：key1=value1和key2=value2，设置后，仪表盘中所有图表的查询分析语句会针对过滤条件进行一次过滤，然后继续执行查询语句中的条件。
    ...
    **说明：** 需手动对filter参数转码。
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910238975_zh-CN.png)
...
-   增加多个变量替换条件。
    ...
    **说明：** 需手动对token参数转码。
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910238976_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/155062910237615_zh-CN.png)
