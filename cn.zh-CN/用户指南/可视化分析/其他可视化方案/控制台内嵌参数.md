...
-   **隐藏上边栏和侧边栏**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637608_zh-CN.png)
...
-   **隐藏导航栏返回按钮**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637609_zh-CN.png)
...
-   **过滤导航栏资源列表**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637610_zh-CN.png)
...
-   **时间选择器**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637611_zh-CN.png)
...
-   **设置queryString**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637618_zh-CN.png)
...
-   **设置readOnly**
    ...
    -   示例效果
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637613_zh-CN.png)
...
-   示例效果
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637612_zh-CN.png)
...
-   URL
    ...
    ```
    https://sls4service.console.aliyun.com/next/project/${ProjectName}/dashboard/${dashboard_name} 
    
    ```

-   示例效果

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637614_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/106800/154883389637615_zh-CN.png)
