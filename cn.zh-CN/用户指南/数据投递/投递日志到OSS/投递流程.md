...
2.  **配置OSS投递规则** 
    ...
    |RAM角色|RAM角色ARN及角色名称，用于访问权限控制，OSS Bucket拥有者创建角色的标识，如何获得ARN请参见[ZH-CN\_TP\_13179.md\#fig\_v5j\_1lm\_12b](intl.zh-CN/用户指南/数据投递/投递日志到OSS/投递流程.md#fig_v5j_1lm_12b)。|如`acs:ram::45643:role/aliyunlogdefaultrole`。|
